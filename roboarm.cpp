...
vec2 tip() {
	...
	y += pos.y + BASE_HEIGHT;
	// lower arm
	x += LOWER_ARM_HEIGHT * -sin(3.14159/180* Theta[LowerArm]);
	y += LOWER_ARM_HEIGHT * cos(-3.14159/180* Theta[LowerArm]);
	// upper arm
	x += (UPPER_ARM_HEIGHT-0.5) * -cos(3.14159/180* (90 - Theta[LowerArm] - Theta[UpperArm]));
	y += (UPPER_ARM_HEIGHT-0.5) * sin(3.14159/180* (90 - Theta[LowerArm] - Theta[UpperArm]));
	// round
	x = (int)(0.5 + x);
	y = (int)(0.5 + y);
